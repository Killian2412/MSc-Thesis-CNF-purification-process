...
Acid_Feed_Lflow = CNF_Feed_TotalFlow*AcidSolution_Multiplier #L/h
...
#cnf_selling_price = 50000 ## Between 25.000 and 113.000 USD per tonne in 2017
...
def full_calculation(parameters):
    ...
    Acid_Feed_volumetricflowmate = sim.STRM_Get_VolumeFlow("HCLFEED")
    ...
    # Conversion of CSTR calculations
    Feed_Ni_moleflow = sim.STRM_CISOLID_Get_MoleFlowPerCompound('CNFFEEDC', 'NI')
    Reactor_out_Ni_moleflow = sim.STRM_CISOLID_Get_MoleFlowPerCompound('CSTROUT', 'NI')
    Reactor_conversion = (Feed_Ni_moleflow - Reactor_out_Ni_moleflow) / Feed_Ni_moleflow
    ...
    return economic_results, equipment_cost_dict, CNF_production_tonnes_per_year, CSTR_parameters, Reactor_conversion

############################################################################################End of Running the simulation


###########################Influence of reactor Temperature on the Conversion
# CSTR_Temperature_List = np.linspace(20, 100, 30)
# Conversion_List = []
#
# for Temperature in CSTR_Temperature_List:
#     print(f"Calculating for CSTR Temperature = {Temperature} *C...")
#     sim.BLK_CISTR_Set_Temperature("CSTR", Temperature)
#     sim.BLK_HEATER_Set_Temperature("CNFCOOLE", Temperature) #Is set equal to CSTR temperature
#
#     economic_results, equipment_cost_dict, production_tonnes_per_year, CSTR_parameters, Reactor_conversion = full_calculation(parameters_data)
#     Conversion_List.append(Reactor_conversion)
#
# plt.figure(figsize=(8, 6))
# plt.plot(CSTR_Temperature_List, Conversion_List, linestyle='-', color='b', alpha=0.5)
# axis1 = plt.gca()
# plt.xlabel('Reactor Temperature (°C)', fontsize = 18)
# plt.ylabel('Reactor Conversion', fontsize = 18)
# plt.ylim(0, 0.1)
...
############################Influence of the reactor pressure on the conversion
# CSTR_Pressure_List = np.linspace(1, 50, 50) #pressure is in atm
# Conversion_List = []
#
# for Pressure in CSTR_Pressure_List:
#     print(f"Calculating for CSTR Pressure = {Pressure} atm...")
#     sim.BLK_CISTR_Set_Pressure("CSTR", Pressure)
#     economic_results, equipment_cost_dict, production_tonnes_per_year, CSTR_parameters, Reactor_conversion = full_calculation(parameters_data)
#     Conversion_List.append(Reactor_conversion)
#
# plt.figure(figsize=(8, 6))
# plt.plot(CSTR_Pressure_List, Conversion_List, linestyle='-', color='b')
# axis2 = plt.gca()
# plt.xlabel('Reactor Pressure (atm)', fontsize = 18)
# plt.ylabel('Reactor Conversion', fontsize = 18)
# plt.ylim(0, 0.1)
...
####################################Influene of the reactor residence time on the conversion
# CSTR_Residencetime_List = np.linspace(1, 24, 24)
# Conversion_List = []
#
# for Residencetime in CSTR_Residencetime_List:
#     print(f"Calculating for CSTR residence time = {Residencetime} hours...")
#     sim.BLK_CISTR_Set_ResidenceTime("CSTR", Residencetime)
#     economic_results, equipment_cost_dict, production_tonnes_per_year, CSTR_parameters, Reactor_conversion = full_calculation(parameters_data)
#     Conversion_List.append(Reactor_conversion)
#
# plt.figure(figsize=(8, 6))
# plt.plot(CSTR_Residencetime_List, Conversion_List, linestyle='-', color='b')
# axis3 = plt.gca()
# plt.xlabel('Reactor Residence Time (hours)', fontsize = 18)
# plt.ylabel('Reactor Conversion', fontsize = 18)
# plt.ylim(0, 0.35)
...
################################Influence of the acid feed amount on the conversion
#
# HCl_Feed_Multiplier_list = np.linspace(10, 1000, 100)
# Conversion_List = []
#
# for Multiplier in HCl_Feed_Multiplier_list:
#     print(f"Calculating for Acid solution multiplier = {Multiplier} x...")
#     Acid_Feed_volumeflow = CNF_Feed_TotalFlow*Multiplier
#     sim.STRM_Set_TotalFlowRate(Streamname="HCLFEED", TotalFlowRate=Acid_Feed_volumeflow)
#     economic_results, equipment_cost_dict, production_tonnes_per_year, CSTR_parameters, Reactor_conversion = full_calculation(parameters_data)
#     Conversion_List.append(Reactor_conversion)
#
# plt.figure(figsize=(8, 6))
# plt.plot(HCl_Feed_Multiplier_list, Conversion_List, linestyle='-', color='b')
# plt.xlabel('HCl feed volumetric flow rate / CNF Feed mass flow rate')
# plt.ylabel('Reactor Conversion')
# plt.title('Influence of the ratio of the acid volumetric flow rate over the CNF feed mass flow rate on the Reactor Conversion')
# plt.ylim(0, 1.1)
# plt.grid(True, linestyle='--', alpha=0.6)
# plt.show()
...
#################################Influence of acid concentration on the reactor conversion
#
# HCl_Feed_Concentration = np.linspace(0.01, 0.5, 50)
# Conversion_List = []
#
# for Concentration in HCl_Feed_Concentration:
#     print(f"Calculating for Acid solution Concentration = {Concentration} massfrac...")
#     H2O_concentration = 1 - Concentration
#     sim.STRM_Set_ComponentFlowRate("HCLFEED", Concentration, "HCL")
#     sim.STRM_Set_ComponentFlowRate("HCLFEED", H2O_concentration, "H2O")
#
#     economic_results, equipment_cost_dict, production_tonnes_per_year, CSTR_parameters, Reactor_conversion = full_calculation(parameters_data)
#     Conversion_List.append(Reactor_conversion)
#
# plt.figure(figsize=(8, 6))
# plt.plot(HCl_Feed_Concentration, Conversion_List, linestyle='-', color='b')
# axis4 = plt.gca()
# plt.xlabel('Mass fraction of HCl in the acid feed', fontsize = 18)
# plt.ylabel('Reactor Conversion', fontsize = 18)
...
############################################Influence of Ni concentration in the feed on the reactor conversion
Ni_massfraction_feed = np.linspace(0.001, 0.20, 200)
Conversion_List = []

for Ni_massfraction in Ni_massfraction_feed:
    Carbon_massfraction = 1 - Ni_massfraction - 0.001127
    sim.STRM_CISOLID_Set_ComponentFlowRate("CNFFEED", Carbon_massfraction, "CARBON")
    sim.STRM_CISOLID_Set_ComponentFlowRate("CNFFEED", Ni_massfraction, "NI")
    economic_results, equipment_cost_dict, production_tonnes_per_year, CSTR_parameters, Reactor_conversion = full_calculation(parameters_data)
    Conversion_List.append(Reactor_conversion)

plt.figure(figsize=(8, 6))
plt.plot(Ni_massfraction_feed, Conversion_List, linestyle='-', color='b')
axis5 = plt.gca()
plt.xlabel('Mass fraction of Ni in the CNF feed', fontsize = 18)
plt.ylabel('Reactor Conversion', fontsize = 18)
axis5.tick_params(axis='y', labelsize=14)
axis5.tick_params(axis='x', labelsize=14)
plt.ylim(0.04, 0.150)
plt.grid(True, linestyle='--', alpha=0.6)
plt.show()
